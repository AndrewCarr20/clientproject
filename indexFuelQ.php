...
$query24 = "SELECT * FROM users WHERE users_id = '$users_id' "; // assoc value state of user_id
$result24 = mysqli_query($mysqli, $query24);


// if ($result2 && mysqli_num_rows($result2) > 0) { // checks if table is empty
$users_data24 = mysqli_fetch_assoc($result24);

$_SESSION['address1'] = $users_data24['address1'];
$_SESSION['city'] = $users_data24['city']; // city 
$_SESSION['state'] = $users_data24['state']; //state
$_SESSION['zipcode'] = $users_data24['zipcode']; //state
$address1 =   $_SESSION['address1'];
$city =   $_SESSION['city'];
$state =   $_SESSION['state'];
$zipcode =   $_SESSION['zipcode'];
// $valu = '$address1' + '$city' + '$state';
// echo $valu;
// echo $city;
// echo $address1;
        ...
        <div class="form">
            <form action="indexFuelQ.php" name="submitFer" method="POST">
                ...
                <div class=" inputfield">
                    ...
                    <input type="text" class="input" name='delivAddress' readonly value=<?php echo "'$address1'";
                                                                                        echo "'$address1,  $city ,$state , $zipcode'";
                                                                                        echo "'$address1'   '$city' '$state'";
                                                                                        //     $vars = ["'$address1' ,  '$city' , '$state'"];
                                                                                        // $str1 = (' "%s", "%s" , "%s"   ' ,$vars);
                                                                                        echo "'$city'";
                                                                                        echo $state; ?>>
            ...
            <form action="indexFuelQ.php" method="POST">
                ...
                <div class="inputfield">
                    <input type="submit" name="submitCalc" value="Get Quote" class="btn" required>
                </div>
