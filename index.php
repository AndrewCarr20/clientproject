  ...
  <?php
    ...
    $errors = array('username' => '', 'userPassword' => '');
        ...
        if (!empty($Username) && !empty($Password)) {
            ...
            if ($result && mysqli_num_rows($result) > 0) {
                ...
                if ($Password == $user_data['userPassword']) {
                    ...
                    $errors['userPassword'] = "Password does not match the username. Need to create user account? click create your account, at the top ?<br/><br/>";
                }
            } //num rows
                ...
                $errors['username'] = "Username does not exist. Need to create user account ?  click create your account , at the top ?<br/>";
            }
        } else {
            $errors['username'] = "no infromation entered Need to create user account ?  click create your account , at the top <br/>";
        }
    }
    ?>
