...
<body>
    ...
    <!--cutoff -->
    <div class="topnav">
        <a class="active" href="indexFuelQuery.php">FuelQuote</a>
        <a href="/hw2.html">Update User Profile</a>
        <a href="/indexHistory.php">History</a>
    ...
    <div class="table1">
        ...
        <table>
            ...
            <tr>
                <td>Example: 100 Gallons</td>
                <td>Example: 2.50$ </td>
                <td>Example: 9997 gilmore ln </td>
                <td>Example: june 5th 2022</td>
                <td>Example: 100 * 2.50$ = 250 </td>
            </tr>
            <tr>
                <td>Example: </td>
                <td>Example: </td>
