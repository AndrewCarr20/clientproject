 ...
 <?php
    ...
    //     if ($fullname !== '') {
    //         $sql = "UPDATE users SET fullname = '$fullname' WHERE users_id = '$users_id' ";
    //         $mysqli->query($sql);
    ...
    //         $sql2 = "UPDATE users SET address1 = '$address1' WHERE users_id = '$users_id' ";
    //         $mysqli->query($sql2);
    //         header('location:http://localhost/ree/createUser.php');
    //         exit();
    //     }
    ...
    //         $sql3 = "UPDATE users SET address2 = '$address2' WHERE users_id = '$users_id' ";
    //         $mysqli->query($sql3);
    //         header('location:http://localhost/ree/createUser.php');
    //         exit();
    //     }
    ...
    //         $sql4 = "UPDATE users SET city = '$city' WHERE users_id = '$users_id' ";
    //         $mysqli->query($sql4);
    //         header('location:http://localhost/ree/createUser.php');
    //         exit();
    //     }
    ...
    //         $sql5 = "UPDATE users SET state = '$state' WHERE users_id = '$users_id' ";
    //         $mysqli->query($sql5);
    //         header('location:http://localhost/ree/createUser.php');
    //         exit();
    //     }
    //     if ($zipcode !== '') {
    //         $sql6 = "UPDATE users SET zipcode = '$zipcode' WHERE users_id = '$users_id' ";
    //         $mysqli->query($sql6);
    //         header('location:http://localhost/ree/createUser.php');
    //         exit();
    //     }
